  ...
  <div class="wrap">
    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline" size="mini">
      <el-form-item label="供应商">
        <el-input v-model="formInline.name" clearable placeholder="可通过ID/名称/缩写 搜索" @keydown.enter.native="onSubmit"/>
      </el-form-item>
    ...
    >
      ...
      <el-table-column prop label="补打次数" align="center" show-overflow-tooltip>
        <template slot-scope="scope">{{ scope.row.reprint_num}}</template>
      </el-table-column>
      <el-table-column prop label="补打时间" align="center" show-overflow-tooltip>
        <template slot-scope="scope">{{ scope.row.reprint_time}}</template>
      </el-table-column>
